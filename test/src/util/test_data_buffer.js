...
module.exports = testCase({
    ...
    testCreate: function( test ) {        
        var ds = jstonkers.utils.DataBuffer.createDataBuffer();
    ...
    testTestBytes: function( test ) {
        ...
        var ds = jstonkers.utils.DataBuffer.createDataBuffer( data );
    ...
    testRead: function( test ) {
        ...
        ds = jstonkers.utils.DataBuffer.createDataBuffer( data );
