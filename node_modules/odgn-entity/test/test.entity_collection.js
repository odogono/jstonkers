...
var EntityCollection = require('../lib/entity/entity_collection');

describe('EntityCollection', function(){

    describe('attributes', function(){
        it('should set page count', function(){
            var c = EntityCollection.create({page_count:15});
            assert.equal( c.get('page_count'), 15 );
        });
    });
