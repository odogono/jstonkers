jstonkers.model.Match = Backbone.Model.extend({
    initialize: function(){
        ...
        var divisions = new jstonkers.model.DivisionList();
        
        _.bindAll(this, 'onChange', 'onChangePlayers');
        this.set({ players:players, teams:teams, divisions:divisions, levels:[], bounds:[], window:[], zoom:1}, {silent:true});
    ...
    onChange: function( players ){
        ...
        this.get('divisions').match = this;
        console.log("+++ changed stuff");
        
        this.get('divisions').each( function(v){ v.match = self; });
    ...
    onChangePlayers: function(){
        ...
        // divisions.each( function(division){ division.match = self; });
